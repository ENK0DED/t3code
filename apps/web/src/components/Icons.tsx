...
export const McpIcon: Icon = (props) => (
  <svg {...props} viewBox="0 0 100 100" fill="none">
    <g stroke="currentColor" strokeLinecap="round" strokeWidth="6.2">
      <path d="m13.214 47.77 35.06-35.06c4.815-4.87 12.71-4.87 17.526 0 4.815 4.82 4.815 12.659 0 17.53L39.312 56.672m.394-.334L65.8 30.24c4.815-4.871 12.714-4.871 17.529 0l.166.169c4.874 4.816 4.874 12.655 0 17.526L51.802 79.632c-1.626 1.622-1.626 4.256 0 5.824l6.493 6.552" />
      <path d="M57.039 21.448 31.11 47.376c-4.839 4.839-4.839 12.687 0 17.53 4.839 4.839 12.687 4.839 17.53 0l25.924-25.929" />
    </g>
  </svg>
);
